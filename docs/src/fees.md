...
There is no additive trader/holder reward leg and no `RewardVault` in production. Every trade carries only
the two fee streams above — nothing else is carved on top.
