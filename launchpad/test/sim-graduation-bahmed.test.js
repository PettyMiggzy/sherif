...
//   (own copy alongside sim-graduation.test.js — does not modify existing tests)
//   FORK_RPC=<rpc> npx hardhat test test/sim-graduation-newcal.test.js
const ONE = 10n ** 18n;
...
suite("Graduation sim (bahmed) — NEW calibration (201600 / 23000 / 22800) lands at ~4.2 ETH / ~$34k", function () {
  this.timeout(240000);
