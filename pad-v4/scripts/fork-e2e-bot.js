...
async function launch(tag, creator, curveTok = 470_000) {
  const cfg = { name: "Robin " + tag, symbol: tag, decimals: 18, supply: E(curveTok * 2 + 100_000), curveSupply: E(curveTok), reserveSupply: E(curveTok), tickSpacing: TS, startTickMag: 0, creator: creator.address, noPoolForever: false };
