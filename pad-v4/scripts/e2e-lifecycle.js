...
async function main() {
  ...
  const cfg = {
    ...
    tickSpacing: TS, startTickMag: 0, creator: creatorA.address, noPoolForever: true, lpFee: 10000, auctionDays: 0,
  };
  ...
  const arrowCfg = {
    ...
    tickSpacing: TS, startTickMag: 0, creator: creatorA.address, noPoolForever: false, lpFee: 10000, auctionDays: 0,
  };
