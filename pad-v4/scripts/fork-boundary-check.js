...
async function launch(factory, tag, creator) {
  const cfg = { name: "Robin " + tag, symbol: tag, decimals: 18, supply: E(1_040_000), curveSupply: E(470_000), reserveSupply: E(470_000), tickSpacing: TS, startTickMag: 0, creator, noPoolForever: false };
