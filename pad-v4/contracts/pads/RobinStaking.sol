...
/// @notice Verbatim port of launchpad/contracts/RobinStaking.sol (v3's pad) — pure OpenZeppelin, zero
/// v3-specific dependencies, so it drops into pad-v4 unchanged. Used here as the DailyAuctionVaultV4's
/// zero-bid-day staking sink (see DailyAuctionVaultV4.sol), same role it plays for v3's DailyAuctionVault.
///
/// Stake one token (e.g. a launched coin) and earn a basket of reward assets — native ETH and/or any ERC-20.
/// Two design rules:
///
...
contract RobinStaking is ReentrancyGuard, Ownable2Step {
    ...
    IERC20 public immutable stakeToken; // the token users stake (e.g. a launched coin)
