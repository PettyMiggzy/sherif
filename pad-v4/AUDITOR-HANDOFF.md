...
**Invariant added:** *the platform wallet's pad-token balance is always exactly zero* — every token-denominated fee stream terminates at staking / burn, never the treasury. Recorded in `ROBIN-V4-CURVE-ECON.md §5`.
