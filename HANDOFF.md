...
- RPC (public): `https://rpc.mainnet.chain.robinhood.com` — the canonical chain RPC.
  (`https://robinhoodchain.blockscout.com/api/eth-rpc` is Cloudflare-challenged: 403 to programmatic
  clients, 429 to browsers. Do not point bots, scripts or wallets at it.)
